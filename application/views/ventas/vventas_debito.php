<?php $cargos_impuestos = $this->Empresa_model->leerCargosImpuestos($this->session->sucursal->idempresa); ?>
        ...
        <div class="row">
            ...
            <div class="container-fluid">
                ...
                <div class="box-body"><!-- Inicio body -->
                    ...
                    <div class="form-group row">
                        <div class="col-12">
                            <input type="hidden" id="factura" name="factura" value="1" >
                        </div>
                        <div class="col-12">
                    ...
                    <div class="form-group row">
                        <div class="col-12">
                            ...
                            <input type="hidden" class="form-control" id="cargo" name="cargo"
                                   value="<?php echo $cargos_impuestos->cargo_debito; ?>"
                            >
                        </div>
                        <div class="col-8"></div>
                    ...
                    <div class="form-group row">
                        <div class="col-8"></div>
                        <label class="col-2 text-right" for="total">Cargo por Transaccion[Bs]:</label>
                        <div class="col-2">
                            <input type="text" class="form-control text-right" id="total" name="total" required readonly
                                   value="<?php

                                   $cargo_debito = ($cargos_impuestos->cargo_debito/100)*$venta_actual['venta_parcial'];

                                   $cargo_debito = round($cargo_debito, 1, PHP_ROUND_HALF_UP);



                                   echo number_format($cargo_debito, 2, '.','');
                                   ?>"
                            >
                        </div>
                    ...
                    <div class="form-group row">
                        <div class="col-8"></div>
                        <label class="col-2 text-right " for="total">Total[Bs]:</label>
                        <div class="col-2 ">
                            <input type="text" class="form-control  text-right " id="ventatotal" name="ventatotal" required readonly
                                   value="<?php
                                   echo number_format($venta_actual['venta_total']+$cargo_debito, 2, '.','');
                                   ?>"
                            >
                        </div>
