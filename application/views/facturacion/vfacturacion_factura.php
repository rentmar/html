        ...
        <div class="row">
            <div class="col-12 d-flex" >
                <div class="ml-auto">
                    ...
                    <a href="<?php echo site_url('Facturacion/imprimirFactura/'.$idventa);?>" class="btn btn-secondary " role="button" target="_blank">
                        <i class="far fa-file-pdf"></i>
                        Factura Normal
                    </a>
                    <a href="<?php echo site_url('Facturacion/imprimirFacturaGrande/'.$idventa);?>" class="btn btn-secondary " role="button" target="_blank">
                        <i class="far fa-file-pdf"></i>
                        Factura Grande
                    </a>
                    <a href="<?php echo site_url('puntoVenta');?>" class="btn btn-secondary " role="button">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <span class="float-right">
                            <strong>Fecha: </strong>
                            <?php echo mdate('%M  %d, %Y',$registro_venta->fecha); ?>
                        </span>
                    </div>
